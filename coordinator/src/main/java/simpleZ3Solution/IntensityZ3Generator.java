...
public class IntensityZ3Generator {
	...
	static void test1(Context ctx) {
		...
		ArithExpr ae = (IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x1Exp, x1Exp), ctx.mkTrue()), ctx.mkInt(0),
				ctx.mkInt(0));

		BoolExpr be = ctx.mkAnd();

		ae = ctx.mkAdd(
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x1Exp, x2Exp), ctx.mkTrue()), intensity[0][1],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x1Exp, x3Exp), ctx.mkTrue()), intensity[0][2],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x1Exp, x4Exp), ctx.mkTrue()), intensity[0][3],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x1Exp, x5Exp), ctx.mkTrue()), intensity[0][4],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x2Exp, x3Exp), ctx.mkTrue()), intensity[1][2],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x2Exp, x4Exp), ctx.mkTrue()), intensity[1][3],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x2Exp, x5Exp), ctx.mkTrue()), intensity[1][4],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x3Exp, x4Exp), ctx.mkTrue()), intensity[2][3],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x3Exp, x5Exp), ctx.mkTrue()), intensity[2][4],
						ctx.mkInt(0)),
				(IntExpr) ctx.mkITE(ctx.mkDistinct(ctx.mkEq(x4Exp, x5Exp), ctx.mkTrue()), intensity[3][4],
						ctx.mkInt(0)),
				ae);

		be = ctx.mkAnd(ctx.mkGe(x1Exp, ctx.mkInt(1)), ctx.mkLe(x1Exp, ctx.mkInt(3)), ctx.mkGe(x2Exp, ctx.mkInt(1)),
